...
class TestAccount:
    def test_login_button_log_in_to_account(self, driver):
        ...
        driver.find_element(*Locators.button_sign_in_account).click()
    ...
    def test_login_button_registration(self, driver):
        ...
        driver.find_element(*Locators.button_login_in_window_registration).click() # нажать на кнопку войти
    ...
    def test_login_button_password_recovery(self, driver):
        ...
        driver.find_element(*Locators.button_login_in_window_password_recovery).click()
